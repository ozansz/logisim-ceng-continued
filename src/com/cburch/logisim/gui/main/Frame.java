...
public class Frame extends JFrame
    ...
    class MyProjectListener
        ...
        public void projectChanged(ProjectEvent event) {
            ...
            if(action == ProjectEvent.ACTION_COMPLETED
    ...
    private static class ComponentAttributeListener
        ...
        public void valueChangeRequested(Attribute attr, Object value) {
            if(!proj.getLogisimFile().contains(circ)) {
                ...
                proj.doAction(CircuitActions.setAttributeValue(circ,
                            comp, attr, value));
            }
        }
    }
    ...
    public Frame(Project proj) {
        ...
        attrTable = new AttributeTable(this, proj);
        ...
        VerticalSplitPane contents = new VerticalSplitPane(
            new HorizontalSplitPane(new JScrollPane(explorer),
                    new JScrollPane(attrTable), 0.5),
            canvasPanel, 0.25);
    ...
    public void viewComponentAttributes(Circuit circ, Component comp) {
        if(comp == null) {
            attrTable.setAttributeSet(null);
    ...
    private void viewAttributes(Tool oldTool, Tool newTool) {
        ...
        if(newAttrs == null) {
            ...
            if(attrTable.getAttributeSet() != oldAttrs) return;
        }
        attrTable.setAttributeSet(newAttrs,
            ToolActions.createTableListener(proj, newTool));
