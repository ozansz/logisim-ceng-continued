        ...
        public Action append(Action other) {
            if(other instanceof Change) {
                ...
                if(oEnd >= start && end >= o.start) {
                    ...
                    System.arraycopy(o.oldValues, 0, nOld, (int) (o.start - nStart), (int) o.oldValues.length);
                    System.arraycopy(oldValues,   0, nOld, (int) (start - nStart),   (int) oldValues.length);
                    System.arraycopy(newValues,   0, nNew, (int) (start - nStart),   (int) newValues.length);
                    System.arraycopy(o.newValues, 0, nNew, (int) (o.start - nStart), (int) o.newValues.length);
