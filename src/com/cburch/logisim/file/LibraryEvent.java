...
public class LibraryEvent {
    ...
    public final static int MOVE_TOOL = 6;
    public final static int ADD_LIBRARY = 2;
    public final static int REMOVE_LIBRARY = 3;
    public final static int SET_MAIN = 4;
    public final static int SET_NAME = 5;
